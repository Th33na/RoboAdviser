...
def recommend_portfolio(intent_request):
    ...
    current_recommendation = investment_recommendation(risk_level)

    session_attributes['current_recommendation'] = current_recommendation
    ...
    del session_attributes['current_recommendation']
    session_attributes['current_recommendation'] = current_recommendation
    return close(
        session_attributes,
        'Fulfilled',
...
def investment_recommendation(risk_level):
    if risk_level is None:
        return "Unknown"
    return RISK_DICT.get(risk_level.lower(), "Unknown")
